...
public class PostTimeProviderTest {
    ...
    public void testCountTimeAgo(){
        ...
        assertTrue(DateTimeCounter.INSTANCE.countTimeAgo(date) > 0);
    }
    ...
    public void testCountTimeAgoWhenIncorrectArgument(){
        ...
        assertTrue(DateTimeCounter.INSTANCE.countTimeAgo(argument) == -1);
    }
    ...
    public void testCountTimeAgoWhenIncorrectArgumentPattern(){
        ...
        assertTrue(DateTimeCounter.INSTANCE.countTimeAgo(pattern1) == -1);
        assertTrue(DateTimeCounter.INSTANCE.countTimeAgo(pattern2) == -1);
        assertTrue(DateTimeCounter.INSTANCE.countTimeAgo(pattern3) == -1);
    }
    ...
    public void testCountTimeAgoWhenIncorrectDate(){
        ...
        assertTrue(DateTimeCounter.INSTANCE.countTimeAgo(date) == -1);
    }
    ...
    public void testGetTimeAgoTextWhenArgumentIsLessThanZero(){
        float time = -100;
        assertTrue(DateTimeCounter.INSTANCE.getTimeAgoText(time).equals("TIME ERROR"));
    }
    ...
    public void testGetTimeAgoTextForMinutes(){
        float time1 = 1;
        float time2 = 45;
        assertTrue(DateTimeCounter.INSTANCE.getTimeAgoText(time1).equals("1 minute ago"));
        assertTrue(DateTimeCounter.INSTANCE.getTimeAgoText(time2).equals("45 minutes ago"));
    }
    ...
    public void testGetTimeAgoTextForHours(){
        ...
        float time2 = 915;
        assertTrue(DateTimeCounter.INSTANCE.getTimeAgoText(time1).equals("1 hour ago"));
        assertTrue(DateTimeCounter.INSTANCE.getTimeAgoText(time2).equals("15 hours ago"));
    }
    ...
    public void testGetTimeAgoTextForDays(){
        ...
        assertTrue(DateTimeCounter.INSTANCE.getTimeAgoText(time1).equals("1 day ago"));
        assertTrue(DateTimeCounter.INSTANCE.getTimeAgoText(time2).equals("20 days ago"));
    }
}
